    ...
    <ProtectedLayout title="Investment Details" subtitle="Review transparent property and return information.">
      <div className="investment-detail-shell">
        ...
        <div className="investment-detail-grid">
          <section className="glass-card detail-section"><p className="eyebrow">Property information</p><h3>At a glance</h3><div className="detail-list"><div><span>Name</span><strong>{property.propertyName}</strong></div><div><span>Location</span><strong>{property.location || 'N/A'}</strong></div><div><span>Type</span><strong>{property.propertyType}</strong></div>{property.agentPhone ? <div><span>Agent Contact</span><strong>{property.agentPhone}</strong></div> : null}</div></section>
